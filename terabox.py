...
def get_data(url: str):
    ...
    reqUrl = f"https://www.terabox.club/share/list?app_id=250528&web=1&channel=0&jsToken={jsToken}&dp-logid={logid}&page=1&num=20&by=name&order=asc&site_referer=&shorturl={shorturl}&root=1"
